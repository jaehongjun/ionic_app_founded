...
export class ContactPage {
  ...
  flagg = true;
  marker;
  KaKaoJavascriptAPIKey = '410f51f5cf462c73b12e4eb2af91a86d';
  constructor(public navCtrl: NavController, public platform: Platform, public _kakaoMapsProvider: KakaoMapsProvider) {
